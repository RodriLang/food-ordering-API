...
public interface ClientMapper {
    ...
    ClientResponseDto toResponseDto(Participant participant);

    @BeanMapping(nullValuePropertyMappingStrategy = NullValuePropertyMappingStrategy.IGNORE)
    void updateClientFromDto(ClientUpdateDto dto, @MappingTarget Participant participant);
    ...
    Participant toEntity(ClientCreateDto dto);
}
